 ...
 */
public class ConvolutionalNeuralNetwork implements Trainable, Predictor {
        ...
        public void train(Integer trainDataSize, Integer testDataSize) throws IOException {
                ...
                MnistDataSetIterator mnistTrain = new MnistDataSetIterator(batchSize, trainDataSize, false, true, true,
                                12345);
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().seed(seed).iterations(iterations)
                                ...
                                .layer(0, new ConvolutionLayer.Builder(5, 5).nIn(nChannels).stride(1, 1).nOut(20)
